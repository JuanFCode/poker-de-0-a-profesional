...
export const CURRICULUM: Module[] = [
  ...
  },
  {
    ...
    index: 5,
    title: "Torneo",
    tagline: "Cuando el stack se acorta y las fichas dejan de ser dinero",
    goal: "Jugar los tramos cortos sin regalar stack y saber cuándo el premio manda sobre las fichas.",
    duration: "2 semanas",
    lessons: [
      {
        slug: "el-stack-manda",
        title: "El stack manda",
        summary: "Los cuatro tramos de ciegas y por qué con 10bb solo existe el all-in.",
        minutes: 8,
        practice: { href: "/herramientas/torneo", label: "Push o fold" },
      },
      {
        slug: "icm-y-la-burbuja",
        title: "ICM y la burbuja",
        summary: "Por qué las fichas que ganas valen menos que las que pierdes.",
        minutes: 8,
      },
      {
        slug: "bounty-e-hypers",
        title: "Bounty e hypers",
        summary: "La recompensa abre los rangos de pago, pero solo cuando cubres al rival.",
        minutes: 7,
        practice: { href: "/herramientas/torneo", label: "Push o fold" },
      },
      {
        slug: "niveles-y-ante",
        title: "Niveles y ante",
        summary: "Cómo cambia el juego cuando entra el ante y cómo se lee tu reloj en ciegas.",
        minutes: 7,
      },
    ],
  },
